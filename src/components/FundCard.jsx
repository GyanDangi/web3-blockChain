...
handleClick}) => {
  ...
  return (
	<div className=' sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
	  <img src={image} alt="fund" className=' w-full h-[157px] object-cover rounded-[15px]' />
	  ...
	  <div className=' flex flex-col p-4'>
		...
		<div className=' flex justify-between flex-wrap mt-[15px] gap-2'>
			<div className='flex flex-col'>
				...
				<p className=' mt-[3px] font-epilogue font-normal leading-[18px] text-[#808191]'>Raised of {target}</p>
			</div>
			<div className='flex flex-col'>
				<h4 className=' font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]'>{remainingDays}</h4>
				<p className=' mt-[3px] font-epilogue font-normal leading-[18px] text-[#808191]'>Days Left</p>
			</div>
		</div>
